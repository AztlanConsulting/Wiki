...
### 2. Evaluar viabilidad del requisito

El equipo analiza si el requisito puede ser implementado considerando la capacidad disponible y las condiciones del proyecto.
