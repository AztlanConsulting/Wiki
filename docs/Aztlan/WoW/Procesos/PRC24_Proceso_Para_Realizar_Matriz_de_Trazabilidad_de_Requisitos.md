...
|--------------|--------------|--------------|
| Inicialización de la Matriz | De una lista de requerimientos del negocio ya acordada/definida por los miembros del proyecto, asignarles un identificador único (ej. BR-01) y registrarlos en las columnas "ID Req. Negocio", "Descripción" y "Origen/Fuente" de la [plantilla RTM](https://docs.google.com/spreadsheets/d/1yY1daMZ_oXeu3huJ-2UJ9qUKr4hWooPbJ5toUc0xc0U/edit?gid=0#gid=0). | REQM SP 1.4 |
