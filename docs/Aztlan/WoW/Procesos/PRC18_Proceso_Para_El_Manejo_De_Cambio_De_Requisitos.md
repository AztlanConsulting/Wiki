...
| Comunicarlo     | Informar al equipo de desarrollo y a los interesados sobre el cambio aprobado para asegurar su correcta implementación.                | RM SP 1.3                 |
## Salidas
...
| ------- | ----------- | ------------- | -------------------------------------- | ---------- |
| 1.0     | Frida y Sebas    | [FALTA]       | Definicion de proceso para cambio de requisito | 27/02/2026 |